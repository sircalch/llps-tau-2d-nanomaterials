...
def build_official_manuscript():
    ...
    t2_data = [
        ...
        ["Surface Excess Energy (37°C)", "Δγ_s", "0.864 µN/m", "0.267 µN/m", "Derived from Langmuir grand potential: Eq. 4"],
        ["Zeta Potential (pH 7.4)", "ψ_s", "-32.4 mV", "-65.0 mV", "Experimental Zeta Potential [13,28]"],
    ...
    body("The 95% confidence intervals in Figure 3b were evaluated via Monte Carlo error propagation (N_MC = 1000 draws, seed = 42) sampling normal distributions of ΔG_ads (±0.5 kcal/mol) and η_eff (±0.02×10⁻³).")
