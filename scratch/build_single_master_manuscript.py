...
def build_official_manuscript():
    ...
    body("Saltelli-Jansen variance decomposition was performed over the 8 parameter distributions detailed in Table 3. First-order (S_i) and total-effect (S_Ti) indices were computed by executing direct physical solvers for every sample.")
