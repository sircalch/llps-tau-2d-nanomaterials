...
def build_official_manuscript():
    ...
    r_abst = p_abs.add_run(
        ...
        "secondary-nucleation-driven aging. Global sensitivity analysis confirms that thermal slope β, ionic strength I, "
        "and segment length N_eff form an overlapping thermodynamic cluster controlling coexistence, while area density a_s "
        "and extraction rate k_ext govern fibrillation arrest."
    )
    ...
    body("Representative parameter scenarios for aqueous-stabilized borophene nanoflakes and Ti3C2Tx MXene were calibrated from audited literature sources and geometric model estimates, as summarized in Table 2.")
